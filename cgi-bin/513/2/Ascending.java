  ...
  public static void  main( String args[ ] ) throws SQLException {
    ...
    Connection conn = ods.getConnection( );
     ...
     try {
      ...
      String query = "select r.isbn, title, round(avg( r.rating )) from books b, rank r where b.isbn=r.isbn group by r.isbn, title having avg(r.rating) >='" + args[0].trim() +"' ORDER BY avg(r.rating) ASC";
      ResultSet rset = stmt.executeQuery(  query );
       
      System.out.print("<h2 align = center><u> Results are in the ascending order</u></h2>");
